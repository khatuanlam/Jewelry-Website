...
export default function Header() {
  ...
  return (
    <>
      <div className="h-2" style={{ backgroundColor: 'rgb(255, 202, 212)', height: '40px' }}></div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-2">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              <Input type="search" placeholder="Tìm kiếm sản phẩm" className="w-64 hidden md:block text-black rounded-full" />
