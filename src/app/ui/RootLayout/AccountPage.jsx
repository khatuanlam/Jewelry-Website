...
import { extractDate } from "@utils/page";
...
export default function AccountPage({ info }) {
    ...
    const updateUserInfo = (e) => {
        ...
        setShowNotification('Thông tin tài khoản đã được cập nhật!');
    };
                        ...
                        <table className="w-full">
                            <thead>
                                <tr>
                                    ...
                                    <th className="border p-2 bg-gray-100 text-black"></th>
                                </tr>
                            </thead>
                            <tbody>
                                {history.map((order, index) => (
                                    <tr className="hover:bg-gray-50" key={index}>
                                        <td className="border p-2 text-center">{extractDate(order.createAt)}</td>
