...
export default function Footer() {
    ...
    return (
        <>
            {/* Footer */}
            <footer className="bg-[#d0d1d2] text-black py-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div>
                            ...
                            <ul className="space-y-2">
                                ...
                                <li onClick={() => { router.push("/stores") }}>Hệ thống cửa hàng</li>
                            </ul>
                        </div>
                        <div>
                            <h3 className="text-lg font-semibold mb-4">Dịch vụ khách hàng</h3>
                            <ul className="space-y-2">
                                <li onClick={() => { router.push("/faq") }}>Câu hỏi thường gặp</li>
                                <li onClick={() => { router.push("/shipping") }}>Chính sách vận chuyển</li>
                                <li onClick={() => { router.push("/returns") }}>Chính sách đổi trả</li>
                            </ul>
                        </div>
                        <div>
